    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex gap-4 text-sm text-muted-foreground order-1 md:order-none">
          ...
          <div>
            Active: <span className="font-medium text-foreground">{counts.active}</span>
          </div>
          <div>
            Inactive: <span className="font-medium text-foreground">{counts.inactive}</span>
          </div>
        </div>
        <div className="flex flex-col gap-2 md:flex-row md:items-center order-2 md:order-none">
          ...
          <Button onClick={() => setIsCreateOpen(true)} className="ml-2">
