...
interface AdminAchievementsDataTableProps<TData, TValue> {
...
export function AdminAchievementsDataTable<TData, TValue>({
  columns,
  data,
  meta,
  filters,
  targetUser,
}: AdminAchievementsDataTableProps<TData, TValue>) {
  // URL Search Params
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex flex-1 items-center space-x-2">
          ...
          />
          <Select value={collected} onValueChange={(val) => setCollected(val || 'all')}>
